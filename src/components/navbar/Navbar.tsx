      ...
      >
        <div className="max-w-screen-xl flex flex-wrap h-full items-center justify-between mx-auto p-4 ">
          <Link href="/" className="flex items-center">
            <span className="self-center text-lg text-center uppercase transition-all font-semibold whitespace-nowrap flex items-center gap-2  ml-5">
              <span className="bb_logo text-2xl translate-y-2 text-zinc-50">
                BURGER
              </span>
              <Image
                src={
